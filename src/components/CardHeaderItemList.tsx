...
const CardHeaderItemList = ({ category, numberPlate }: ICardHeaderItemListProps) => {
    ...
    return (
        <div className="flex justify-center">
            <div className="inline-flex flex-nowrap items-center gap-3 lg:gap-4 rounded-xl lg:rounded-2xl px-6 lg:px-8 py-4 lg:py-5 shadow-deliveroo mx-auto border border-solid border-[#f2e8cf] bg-[#fef6e4]">
                ...
                <div className="ml-1 text-white text-center border-0 px-4 lg:px-4 py-2 lg:py-2 rounded-xl text-sm font-semibold bg-gradient-to-r from-[#2a9d8f] to-[#219ebc] min-w-[80px]">
                    {numberPlate} piatti
                </div>
